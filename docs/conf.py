...
latex_documents = [
    ('index',
     'zopefilerepresentation.tex',
     'zope.filerepresentation Documentation',
...
texinfo_documents = [
    ('index',
     ...
     'Zope Foundation and Contributors',
     'zopefilerepresentation',
     'Interfaces for file-system and file-system-like representations of'
     ' objects, such as file-system synchronization, FTP, PUT, and WebDAV.',
     'Miscellaneous'),
]
...
extlinks = {
    'issue': (
        'https://github.com/zopefoundation/zope.filerepresentation/issues/%s',
        'issue #'),
    'pr': (
        'https://github.com/zopefoundation/zope.filerepresentation/pull/%s',
        'pull request #')}
